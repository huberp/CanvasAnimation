...
/**
 * Process All Sprite Sheets - Convex Decomposition
 * 
 * This script processes all known sprite sheets in the project and generates
 * convex decomposition metadata for each one using the Bayazit algorithm.
 */
...
async function main() {
    console.log('🚀 Processing all sprite sheets with convex decomposition...\n');
    
    const projectRoot = path.join(__dirname, '..');
    const scriptPath = path.join(__dirname, 'generateConvexDecompositionMeta.js');
